...
class ProductView(View):
    def get(self, request):
        ...
        if search:
            product=Product.objects.filter(category__category__icontains=search)
        else:
            product=Product.objects.all()
        ...
        return render(request,'home.html',{'Categories':Categories,'product':product,'totalitem':totalitem,})
